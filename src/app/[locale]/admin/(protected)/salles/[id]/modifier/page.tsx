...
import { getAdminVenue, getAdminVenueSetups } from "@/lib/admin/venues/get-admin-venues";
...
export default async function EditVenuePage({ params }: PageProps) {
  ...
  const [venue, setups] = await Promise.all([getAdminVenue(id), getAdminVenueSetups()]);
  ...
  return <AdminVenueForm mode="edit" venue={venue.venue} setups={setups.ok ? setups.setups : []} />;
}
